<template>
  <div class="duck_portrait">
    <svg version="1.1" class="main-duck-img" x="0px" y="0px" viewBox="0 0 135 135">
      <g>
        <ellipse cx="89.6" cy="44" rx="8.5" ry="7.6"/>
      </g>
      <g>
        <path :style="{ fill: color }" d="M63.1,125.1c52.6,0,40.3-38.7,34.3-52.3c-0.7-1.9-0.4-4,0.9-5.5c2-2.1,3.4-4.7,4.4-7.5
